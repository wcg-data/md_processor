...
### v1.5 (当前版本) - 2025-11-02
- **关键修复**: on_batch 过滤规则严格化，与 on_tick 完全一致
- **修复内容**: 在 `parquet_processor_on_batch.rs` 的过滤逻辑中添加 volume-turnover 一致性检查
- **修复效果**:
  - 修复前: 8,087/8,703 (92%) 合约一致，616 个合约有差异
  - 修复后: 8,656/8,656 (100%) 完全一致 ✅
- **数据影响**: 严格拒绝 volume>0 且 turnover=0 的异常数据（主要是2010-2011年早期数据）
- **验证结果**: SR1109 等问题合约差异从 97.4% 降至 0%
- 详见: `on_batch过滤规则严格化修复报告.md`
